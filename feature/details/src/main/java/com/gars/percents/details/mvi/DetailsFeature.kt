...
import com.gars.percents.data.Percent
...
class DetailsFeature(
    percent: Percent,
    calculatorUseCase: com.gars.percents.details.damain.CalculatorUseCase
    ...
    data class State(
        val status: Status,
        val month: String = "",
        val accrual: List<com.gars.percents.details.data.AccrualItem> = emptyList(),
    ...
    sealed class Effect {
        ...
        data class ResultSuccess(val actuals: List<com.gars.percents.details.data.AccrualItem>) : Effect()
        data class ResultError(val error: Throwable) : Effect()
    }

    class ActorImpl(
        private val calculatorUseCase: com.gars.percents.details.damain.CalculatorUseCase,
